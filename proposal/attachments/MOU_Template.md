...
**Party A:**
**ItracXing Technology Co., Ltd. (準旺科技股份有限公司)**
...
**WHEREAS**, Arviem is a global leader in real-time cargo monitoring and supply chain visibility;
...
### Phase 2: Project Execution & Field Validation (Jan 1, 2026 – Jun 30, 2027)
...
1.  **International Testbed (Field Validation):**
    ...
    *   This includes validating ItracXing’s **"Smart TOTE"** devices and **"AI-MaaS"** platform in real-world cross-border environments.

2.  **Data Collaboration & AI Model Training:**
    *   Arviem agrees to share relevant **historical and real-time logistics data** (including but not limited to sensor logs, GPS tracks, and event records) to support the training of ItracXing’s AI models.
    *   **Target Models:**
        *   **BHI/RUL:** Battery Health Index and Remaining Useful Life prediction.
...
*   **ItracXing:**
    *   Lead the R&D of core AI algorithms (BHI, RUL, NLQ, Anomaly Detection).
    *   Develop the "Smart TOTE" hardware and "AI-MaaS" cloud platform.
    *   Ensure compliance with MOEA requirements and project deliverables.

*   **Arviem:**
    *   Provide domain expertise, client use cases, and EU market requirements.
    *   Facilitate field testing and data access.
    *   Provide feedback on UI/UX and operational feasibility.
...
| **Name:** Jeff Shuo | **Name:** [Authorized Signatory] |
| **Title:** CIO | **Title:** [Title] |
