...
| 年度   | 政府補助款 | 申請公司自籌款 | 工研院/學研中心 | 計畫總經費 | 計畫人月數 |
|:------:|-----------:|---------------:|------------------:|-----------:|-----------:|
| 第1年度 | 11,840     | 11,840         | 600               | 24,280     | 120        |
| **合計** | **11,840** | **11,840**     | **600**           | **24,280** | **120**    |
| 占總經費比例 | 48.8% | 48.8% | 2.4% | 100% | - |
...
| Project Manager    | 90          | 12        | 1,080               | 專任       |
| AI工程師 ×2        | 80          | 36        | 2,880               | 含待聘1人  |
| 全端工程師 ×2      | 75          | 20        | 1,500               |            |
| IoT韌體工程師      | 75          | 12        | 900                 |            |
| 小計               | —           | 98        | 9,330               |            |
...
備註：本表公司人員投入人月合計 98 PM；計畫總人月數 120 PM 之差額 22 PM 由 ITRI/學研單位與外部顧問投入（列入「委託研究/驗證費」），不重複計入公司人事費。
...
|---|---|---:|---:|---:|---|
| GPU 雲端訓練資源（暫時性/可關閉） | 按量 | 250 | 8 | 2,000 | RL/異常偵測模型訓練（Phase II） |
| 託管資料庫（PostgreSQL/Mongo） | 月租 | 50 | 12 | 600 | NL 查詢/後端服務資料庫 |
| 物件儲存與流量（冷/熱存取） | 月租 | 70 | 12 | 840 | 感測資料與模型工件存放 |
| 監控/日誌（APM/Logging） | 月租 | 20 | 12 | 240 | 服務可用性與追蹤 |
| API Gateway/負載平衡 | 月租 | 20 | 12 | 240 | 對外 API 與安全控管 |
| CDN/下載加速 | 月租 | 25 | 12 | 300 | 文件/前端資源加速 |
| EDA/開發工具雲端租賃 | 月租 | 100 | 6 | 600 | MCU/PCB 工具短期租用 |
| CI/CD Runner（託管） | 月租 | 50 | 12 | 600 | 自動化測試/部署 |
| 小計 | — | — | — | 5,420 | 金額單位：千元 |

說明：本雲端支出以訓練及推論用途為主，屬研發期間暫時性支出，非一般主機代管。
...
| 項目             | 單位 | 數量 | 單價 | 第1年度 | 用途說明 |
|------------------|------|------|------|---------|----------|
| 委託研究/驗證    | 工研院/學研中心 | 1    | 600  | 600     | RL驗證、系統性能測試（含驗證與報告製作費） |
...
## 二、歲出預算分配表（彙總表）
| 會計科目 | 補助款 | 自籌款 | 工研院/學研中心 | 合計 |
|---|---:|---:|---:|---:|
| 1.人事費 | 7,000 | 7,000 |  | 14,000 |
| 2.消耗性器材及原材料費 | 810 | 810 |  | 1,620 |
| 3.設備使用費 | 3,250 | 3,250 |  | 6,500 |
| 4.設備維護費 | 500 | 500 |  | 1,000 |
| 5.無形資產引進/委託研究/驗證 |  |  | 600 | 600 |
| 6.國內差旅費 | 200 | 200 |  | 400 |
| 7.專利申請獎勵金 | 80 | 80 |  | 160 |
| **總開發經費** | **11,840** | **11,840** | **600** | **24,280** |
| **百分比** | **48.8%** | **48.8%** | **2.4%** | **100%** |
