...
|---|---|---:|---:|---:|---|
| 監控/日誌（APM/Logging） | 月租 | 20 | 1 | 20 | 最低限度雲端監控成本（其餘資源由合作研發單位提供） |
| 小計 | — | — | — | 20 | 金額單位：千元 |

說明：多數雲端資源由合作研發單位提供並納入「（四）技術引進、委託研究或合作研發費」，本項僅保留最低必要監控支出。
...
| 項目             | 單位 | 數量 | 單價 | 第1年度 | 用途說明 |
|------------------|------|------|------|---------|----------|
| 合作研發與驗證   | 工研院 AI 中心／Arviem AG／台灣–阿姆斯特丹大學 AI 合作中心 | 1 | — | 6,000 | (1) 工研院 AI 中心：強化學習與多智能體模組共同研發、系統性能驗證與測試報告。<br>(2) Arviem AG：歐洲場域測試、IoT 冷鏈數據驗證與跨境資料回傳。<br>(3) 台灣–阿姆斯特丹大學 AI 合作中心：聯邦學習、AI 倫理與可解釋模型協同研究。<br>共同建立可出口之 SaaS 供應鏈 AI 解決方案。 |
...
| 3.設備使用費 | 550 | 550 |  | 1,100 |
| 4.設備維護費 | 500 | 500 |  | 1,000 |
| 5.無形資產引進/委託研究/驗證 | 2,700 | 2,700 | 600 | 6,000 |
| 6.國內差旅費 | 200 | 200 |  | 400 |
| 7.專利申請獎勵金 | 80 | 80 |  | 160 |
