...
| Sean     | AI工程師       | 碩士（資工）     | NLP、LLM、語意查詢、A1分工          | 12       | 男   | ItracXing |
| Gary     | 資料科學家     | 碩士（統計）     | 異常偵測、時序分析、A2分工          | 12       | 男   | ItracXing |
| Neil     | 演算法工程師   | 學士（電機）     | Kalman濾波、訊號處理、A3分工        | 12       | 男   | ItracXing |
| 鄺宏     | 全端工程師     | 碩士（資工）     | 資料庫設計、API整合、A4分工         | 12       | 男   | ItracXing |
| 謝子元   | 軟體工程師     | 學士（資工）     | 後端開發、資料管道、A1–A4支援       | 12       | 男   | ItracXing |
| （待聘） | AI工程師       | 碩士（AI/資工）  | RL、聯邦學習、Phase II/III分工      | 12       | 女   | ItracXing |
（待聘）	AI工程師	碩士（AI/資工）	RL、聯邦學習、Phase II/III分工	12	女	ItracXing
...
| 項目             | 單位 | 數量 | 單價 | 第1年度 | 用途說明 |
|------------------|------|------|------|---------|----------|
| 委託研究/驗證    | 工研院/學研中心 | 1    | 600  | 600     | RL驗證、系統性能測試 |
