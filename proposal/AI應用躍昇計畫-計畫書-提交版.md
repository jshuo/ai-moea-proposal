...
### **Phase II：AI 警示優化與智慧採樣整合（7.5 個月）— 開始日期：2026/06/15**
...
- B1 警示優化與路線異常預測 (15%) – ItracXing 準旺科技  
- B2 IoT 智慧採樣策略優化與部署 (19%) – ItracXing 準旺科技  
- B3 聯合驗證與測試 (5%) – ITRI + 學研中心



### **Phase III：多智能體部署與國際展示（6 個月）— 開始日期：2026/11/30**
...
- C1 多智能體協作與管控（不含 DB 接入）(8%) – ItracXing 準旺科技  
- C2 聯邦學習 POC (7%) – ItracXing 準旺科技 + 學研中心  
- C3 生產部署 (6%) – ItracXing 準旺科技  
- C4 API 與文件 (3%) – ItracXing 準旺科技  
...
gantt
  ...
  section Phase I: AI原型與資料管道（5個月）
    A1 自然語言查詢                 :a1, 2026-01-01, 3.5m
    A2 電池異常偵測                 :a2, 2026-01-01, 3.5m
    A3 Kalman降噪                   :a3, 2026-01-01, 3.0m
  A4 MCP資料庫存取/查詢整合        :a4, 2026-04-15, 2026-05-31

    section Phase II: RL整合（7.5個月）
  B1 DQN警示優化              :b1, 2026-06-01, 4.0m
    B3 IoT採樣策略優化與部署    :b3, 2026-06-01, 5.5m
  B2 自適應Kalman調校             :b2, 2026-06-01, 3.5m
    B5 聯合驗證與測試               :b5, after b1 b3 b2, 1.0m
...
- **2026/04中–2026/05底（Phase I 後段）**：完成 A4 MCP資料庫存取/查詢整合（查核點 A.2）  
- **2026/06初–2026/12（Phase II）**：完成 B1 訓練與A/B測試、B3 採樣策略優化與部署（查核點 B.1、B.2）  
...
- **B.1（2026/09）**：警示誤報率≤20%；F1-score≥0.85；採樣策略優化部署完成。  
