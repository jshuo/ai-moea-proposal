...
有效提升整體運輸監測效能與營運可持續性。  
完成後可使 Arviem 客戶即時掌握貨況、降低欺詐風險、延長感測器壽命並降低維運成本。
...
Phase III 完成後，系統將具備「分散協作、隱私保護、即時預警」的 AI 供應鏈監控能力。  
整合異常警示、環境監測與智慧採樣決策，可支援 Arviem 客戶即時掌握運輸風險並主動調整貨櫃配置。  
同時透過國際展示與聯邦學習驗證，展現台灣 AI 技術在全球供應鏈的落地價值與品牌影響力。  
...
|---|---|---:|---:|---:|---|
| AWS/Azure 運算資源（GPU 訓練） | 按量計費 | 50 | 18 | 900 | RL模型訓練（DQN）、LLM微調、異常偵測模型訓練；Phase I–III 分階訓練；**調整至合理訓練資源水平** |
...
**雲端資源分配策略**：
- **Phase I（前5個月）**：著重原型開發與模型驗證，GPU訓練成本較高（約40%預算）
...
| 會計科目 | 補助款 | 自籌款 | 合計 | 占比 |
|---|---:|---:|---:|---:|
| 1.人事費 | 6,270 | 6,260 | 12,530 | 51.0% |
| 2.消耗性器材及原材料費 | 810 | 810 | 1,620 | 6.6% |
| 3.設備使用費/雲端租賃費 | 1,440 | 1,440 | 2,880 | 11.7% |
| 4.設備維護費 | 700 | 700 | 1,400 | 5.7% |
| 5.技術引進/合作研發費 | 2,600 | 2,600 | 5,200 | 21.2% |
| 6.國內差旅費 | 200 | 200 | 400 | 1.6% |
| 7.專利申請獎勵金 | 80 | 80 | 160 | 0.7% |
...
## (一)2027-2029 三年營收預測（IoT 裝置銷售與服務收入）
...
| **總收入 (a+b+c)** | **$93,000** | **$752,000** | **$1,142,000** | **$1,560,000** |
