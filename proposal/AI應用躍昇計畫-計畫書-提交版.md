...
| **C. 敏感貨品環境風險預警** | 溫濕度/品質預測模型、Digital Twin | 提前預測濕度異常與變質風險，降低貨損、索賠風險。 |
...
| **敏感貨品品質控管** | 僅能事後確認異常，無法提前處置，貨損風險高。 | Smart TOTE 提供即時溫度與濕度 (Temperature & Humidity) 感測資料，AI 預測其趨勢並 **提前預警 + 介入**，降低貨損與索賠。 |
...
- **職稱：** 機器學習工程師  
- **專長：** 學習排序/成本敏感建模、PyTorch、Kalman 濾波、模型優化  
